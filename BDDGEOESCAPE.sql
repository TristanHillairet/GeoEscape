...
--
-- Hôte : localhost:3306
-- Généré le : dim. 04 déc. 2022 à 18:44
...
(1, 2, 'corps', 10, 48.853381, 2.348262, 1, 'Le cadavre montre la direction nord-est avec son bras et tient dans l\'autre main un plan d\'aéroport.', 4, 0, 0, '', '', 0),
(2, 3, 'ticket d\'avion', 10, 48.853584, 2.346917, 1, 'un ticket d\'avion illisible ', 1, 0, 0, '', '', 0),
(3, 4, 'directeur de l\'aéroport', 14, 49.007671, 2.543412, 1, '\"Que puis-je faire pour vous aider?\"', 3, 13, 2, '', '<strong> Indice </strong> \"Voulez-vous que je vous aide à trouver l\'origine d\'un ticket\"', 0),
(4, 5, 'lettre cryptée par un mot clé', 10, 52.37644, 4.894098, 1, 'La lettre est cryptée. Un indice est cependant présent, il dit : \"Je suis le capitaine d\'une fiction de Jules Verne mais aussi le nom d\'un musée scientifique de cette ville\".\r\n\r\nCliquez sur l\'objet pour entrer le code.', 2, 5, 0, 'NEMO', '<strong> Indice </strong> : Le code est aussi le nom d\'un célèbre poisson clown de dessin animé.', 0),
(5, 6, 'lettre décryptée', 10, 52.37644, 4.894098, 0, 'Bravo, vous avez réussi mon énigme. Comme je suis sûr que vous ne me trouverez jamais, je peux vous dire qu\'avant de partir d\'ici, je suis allé visité le zoo Artis de la ville. </br>\r\nBonne chance inspecteur, </br>\r\nLe Geo-killer.', 4, 0, 0, '', '', 0),
(6, 1, 'statue de la liberté miniature', 16, 52.366638, 4.91572, 1, 'Une latitude est affichée sur cette figurine de la Statue de la Liberté, mais pas la longitude.\r\n\"Latitude = 51.5117899\"', 4, 0, 0, '', '', 0),
...
(9, 7, 'ordinateur de police LN', 10, 51.5027761, -0.1243976, 1, 'Un ordinateur de police', 3, 11, 10, '', '<strong> Indice </strong>: vous pouvez par exemple utiliser cet ordinateur pour faire des analyses. ', 0),
